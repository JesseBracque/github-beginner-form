  ...
  <div id="app">
    <form @submit.prevent="handleSubmit">
      ...
      <div class="form-group queryType">
        ...
        <div v-if="errors.option" class="error-message">
          {{ errors.option }}
        </div>
      </div>
      ...
      <div class="form-group consent">
        ...
        <label for="contactConsent"
          >I consent to being contacted by the team<span class="required"
            >*</span
          ></label
        >
        <div v-if="errors.contactConsent" class="error-message">
...
form {
  ...
  grid-template-rows: 0.5fr 1fr 1fr 1fr 2fr 0.5fr 0.75fr;
  column-gap: 1rem;
}
